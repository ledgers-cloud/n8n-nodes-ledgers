...
export const InvoiceOperations: INodeProperties[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { displayName: 'Contact ID', name: 'id', type: 'number', description: 'Contact ID if Available', default: 0 },
    ...
    options: [
      {
        ...
        values: [
          ...
          { displayName: 'Item ID', name: 'pid', type: 'string', description: 'Item ID if Available', default: '' },
          ...
          { displayName: 'Variant ID', name: 'variant_id', type: 'string', description: 'Variant ID if Available', default: '' },
        ],
      },
    ],
    displayOptions: {
  ...
  },
  {
    ...
    options: [
      ...
      {
        displayName: 'Invoice Date', name: 'invoice_date', type: 'string', placeholder: 'YYYY-MM-DD', default: '' },
      {
      ...
      {
        displayName: 'Validity Date', name: 'validity_date', type: 'string', placeholder: 'YYYY-MM-DD', default: '' },
    ],
    displayOptions: {
      show: {
        resource: ['invoice'],
	...
	},
	{
		...
		options: [
			...
			{ name: 'View and Download', value: 'viewAndDownload' },
		],
		default: 'view',
		displayOptions: {
			show: {
		...
		description: 'Choose whether to only view the invoice or also download the PDF',
	},
	{
