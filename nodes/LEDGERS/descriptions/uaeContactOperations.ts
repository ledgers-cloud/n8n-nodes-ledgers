...
export const uaeContactOperations: INodeProperties[] = [
	{
	...
	},
	{
		...
		default: '',
		displayOptions: {
			show: { operation: ['createUaeContact'] },
		},
	},
	{
		...
		options: [
			...
			},
			{
				...
				type: 'options',
				options: [
					{ name: 'Branch of Foreign Company', value: 'BRANCH_FOREIGN_COMPANY' },
					{ name: 'Civil Company', value: 'CIVIL_COMPANY' },
					{ name: 'Free Zone Company', value: 'FREE_ZONE_COMPANY' },
					{ name: 'Holding Company', value: 'HOLDING_COMPANY' },
					{ name: 'LLC', value: 'LLC' },
					{ name: 'Others', value: 'OTHERS' },
					{ name: 'Partnership', value: 'PARTNERSHIP' },
					{ name: 'Private Joint Stock Company', value: 'PRIVATE_JOINT_STOCK_COMPANY' },
					{ name: 'Public Joint Stock Company', value: 'PUBLIC_JOINT_STOCK_COMPANY' },
	...
	},
	{
		...
		default: '',
		displayOptions: {
			show: { operation: ['updateUaeContact'] },
		},
	},
	{
		...
		options: [
			{
				displayName: 'Contact Update Details',
